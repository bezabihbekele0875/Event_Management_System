...
export default function RegistrationForm({ isOpen, onClose, onSubmit, editEvent }) {
  ...
  // Populate form fields if editing an existing event
  useEffect(() => {
    if (editEvent) {
      ...
      // Clear fields for fresh creation
      setTitle('');
      setDescription('');
      setDate('');
      setCapacity(50);
    ...
    <div style={{
      ...
      <div className="glass-panel" style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          {/* Type Select (Only Editable on Creation) */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
            ...
            <select
              ...
              disabled={!!editEvent}
              style={{
                cursor: editEvent ? 'not-allowed' : 'pointer',
                opacity: editEvent ? 0.6 : 1
              }}
            >
