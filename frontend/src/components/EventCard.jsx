...
import { CalendarDays, Users, Pencil, Trash2, Check, Loader } from 'lucide-react';
        ...
        {isRegistered ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <div style={{
              ...
              <Check size={16} />
              <span style={{ fontWeight: 600 }}>Registered Successfully</span>
            </div>
            <button
              onClick={async () => {
              ...
              style={{ 
                ...
                justifyContent: 'center',
                gap: '0.4rem',
                background: isCancelling ? 'var(--text-muted)' : undefined,
                cursor: isCancelling ? 'not-allowed' : 'pointer'
              }}
            >
              {isCancelling && <Loader size={14} style={{ animation: 'spin 1s linear infinite' }} />}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              <button
                ...
                disabled={isFull || registrationDisabled || isRegistering}
              ...
              >
                {isRegistering && <Loader size={14} style={{ animation: 'spin 1s linear infinite' }} />}
                {registrationDisabled ? 'Registration offline' : isFull ? 'Sold Out' : isRegistering ? 'Registering...' : 'Register Now'}
              </button>
            </div>
